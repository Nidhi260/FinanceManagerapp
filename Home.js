...
const Home = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error("Error adding transaction, try again", toastOptions);
    } finally {
      setLoading(false);
    }
  };
        ...
        <Container className="mt-3">
          <div className="filterRow">
            ...
            <div className="iconBtnBox">
              <FormatListBulletedIcon onClick={() => setView("table")} className={view === "table" ? "iconActive" : "iconDeactive"} />
              <BarChartIcon onClick={() => setView("chart")} className={view === "chart" ? "iconActive" : "iconDeactive"} />
            </div>
